...
from glc.channels.catalogue.whatsapp.twilio_sandbox import send_sandbox_message
...
@patch("glc.channels.catalogue.whatsapp.twilio_sandbox.Client")
@patch("os.getenv")
def test_twilio_sandbox_sends_message(mock_getenv, mock_client):
    ...
    from glc.channels.catalogue.whatsapp import twilio_sandbox
    twilio_sandbox.acc_sid = "sid"
    twilio_sandbox.token = "token"
